defmodule Minecraft.Packet.Server.Login do
  @moduledoc false
  defmodule EncryptionRequest do
    @moduledoc false
    ...
    def serialize(%__MODULE__{} = packet) do
      ...
      {1,
       <<encode_string(packet.server_id)::binary, public_key_len::binary,
         packet.public_key::binary, verify_token_len::binary, packet.verify_token::binary>>}
    end
    ...
    def deserialize(data) do
      ...
      {%__MODULE__{server_id: server_id, public_key: public_key, verify_token: verify_token},
       rest}
    end
  end

  defmodule LoginSuccess do
    @moduledoc false
